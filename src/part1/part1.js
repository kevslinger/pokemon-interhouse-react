                    ...
                    {this.state.showOpening ?
                        <div className={"opening-scene"}>
                            ...
                            <button className={"continue-game"}
                                ...
                                <div className={"column"}>
                                    <br/>
                                    <div className={"column2"} id={"top-row"} style={{"color": HOUSECOLORS[this.state.house]}}>{this.state.house.toUpperCase()}</div>
                                    <div className={"column2"} style={{"color": HOUSECOLORS[this.state.house]}}>{this.state.pottadex}</div>
                                </div>
                                <div className={"column"}>
                                    <br/>
                                    <div className={"column3"} id={"top-row"} style={{"color": HOUSECOLORS[this.state.house]}}>TIME</div>
                                    <div className={"column3"} style={{"color": HOUSECOLORS[this.state.house]}}>BADGES</div>
                                </div>
                                <div className={"column"}>
                                    <br/>
                                    <div className={"column4"} id={"top-row"} style={{"color": HOUSECOLORS[this.state.house]}}>{this.state.time}</div>
