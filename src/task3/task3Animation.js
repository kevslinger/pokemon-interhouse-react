    ...
    constructor(props) {
        ...
        this.state.part2Script = [
            ...
            "Head out east using Rt. 23 to get to Sencha Springs, a piping hot tourist destination with one of the " +
                "most renowned gyms of this region, the Fire gym. A little birdie told me its leader loves dancing on fire.",
            ...
            "Fire is all about passion, and this gym is all about sharing passion. Before we battle you have to show " +
            "me what gets the fire dancing behind your eyes! Actually, pitch it to me like a blazing fast ball so I " +
            ...
            "Once upon a time, Tapu Fiti Oasis was not a desert, but one of the biggest forests in the world. Nowadays, " +
                "the land no longer looks favorably upon new travelers. You'll have to prove your worth to them (or just " +
    ...
    runAnimationBeforeCallback = async(currentLevel) => {
        ...
        if (this.state.gameVersion === 3) {
            if (currentLevel === 3) {
                ...
                this.setState({hideProf: false, highlightLeader2: false});
            }
        }
    }
