    ...
    return (
        <Switch>
            ...
            <Route exact path={"/red2"}>
                <Task2Animation house={"Gryffindor"} time={"02:39:27"} badges={"3"} pottadex={"24"} pottamon={"fawkesindor"}/>
            </Route>
            <Route exact path={"/badger2"}>
                <Task2Animation house={"Hufflepuff"} time={"01:57:05"} badges={"3"} pottadex={"19"} pottamon={"ryslexica"}/>
            </Route>
            <Route exact path={"/slytherin2"}>
                <Task2Animation house={"Slytherin"} time={"03:03:30"} badges={"3"} pottadex={"33"} pottamon={"iffy"}/>
            </Route>
