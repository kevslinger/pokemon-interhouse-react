            ...
            <div style={{"backgroundColor": "#9DB7F5"}}>
                ...
                <div style={{"position": "relative"}} className={"task-container"}>
                    ...
                    <p className={"task-intro-p-text"} style={{"gridArea": "text"}}>
                        ...
                        <br/><br/>
                        Whether you want to write a Petrarchan or Shakespearean sonnet, an acrostic poem, a
                    ...
                    <p className={"task-intro-p-text"} style={{"gridArea": "meta"}}>
                        <strong>Meta</strong>
                        <br/>
                        This task is to create 1 poem. The house may choose to format the poem however they see fit
                        (text-only, picture of poem, video in which the poem is read aloud). The entry must be clearly
                        recognisable as a poem, be an original creation, preferably written in English, and must be at
                        least 150 characters. The poems can be about anything, as long as they are SFW. Please provide
