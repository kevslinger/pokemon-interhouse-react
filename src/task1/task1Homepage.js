          ...
          <div>
              ...
              <div style={{"position": "relative"}} className={"task-container"}>
                  ...
                  <p className={"task-intro-p-text"} style={{"gridArea": "text"}}>
                      ...
                      <br/><br/>
                      The closest gyms to us would be of the Rock, Water, and Electric varieties. If you head up Rt 11
                      ...
                      <br/><br/>
                      If you decide to face the Water gym, you’ll need only to go down Rt 13. But be warned, she tends
                      to speak exclusively in dad jokes. I hear her favorite show is dancing with the staryus...
                      <br/><br/>
                      ...
                      static shock!
                      <br/><br/>
                      After you beat these three gym leaders, your team representatives should report back to me with
                      your findings no later than October 11 at 11:59pm EDT. I look forward to reading your reports!
                  </p>
