...
class Task2Animation extends Task1Animation {
    constructor(props) {
        ...
        this.state.part2Script = [
            ...
            "And how about the work on learning more about these magical creatures and " +
                "the elements they harness?",
            ...
            `In fact, we loved the ${props.pottamon.charAt(0).toUpperCase() + props.pottamon.slice(1)} you showed us ` +
                "so much, we went out and found one ourselves!",
            "Now, I think it's time you moved onto some of the other gyms in our area, to challenge their leaders and " +
                "get even closer to gaining mastery of your calling.",
            ...
            "Prof. Squash: There is a Psychic gym off Route 16 in Zimbardo Village. The gym leader there... well, Ra's " +
                "will have a most interesting challenge for all who knock knock upon his door.",
            "Ra's: Baby, I'm a Mismagius. I'll make all your wildest dreams come true... That is, provided you can get me " +
                "STOKED with your best jokes!",
            ...
            "Prof. Squash: And going out west on Route 18 to Ethelene Center will lead you to the mysterious Poison gym. " +
                "We don't know much about it, or its gym leader, ShadowOfApollo, but whatever you do, don't stare into the mask.",
            ...
            "Prof. Squash: Thanks for all your help so far! We've learned a lot in our time together, and I'm looking " +
                "forward to hear your next research update by October 18th.",
            `Well don't just stand there, Team ${props.house}! Go! Run! Earn more badges!`
        ];
        this.state.pottamon = props.pottamon;
        this.state.leader1Path = "spludgiexx.png";
        this.state.leader2Path = "ra.png";
        this.state.leader3Path = "shadow_with_snapebat.png";
    }
    ...
    runAnimationBeforeCallback = async(currentLevel) => {
        ...
        if (this.state.gameVersion === 2) {
            if (currentLevel === 3) {
                this.setState({showHousePottamon: true});
            }
            if (currentLevel === 5) {
                this.setState({showLeader1: true, hideHousePottamon: true, highlightLeader1: true});
            ...
            } else if (currentLevel === 6 || currentLevel === 9 || currentLevel === 12) {
                this.setState({
                    hideProf: true,
                });
            } else if (currentLevel === 14) {
                this.setState({highlightLeader3: false, hideProf: false, hideHousePottamon: false});
            }
        }
    }
